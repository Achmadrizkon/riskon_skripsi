                    ...
                    <div class="">
                        ...
                        <div class="col col-login mx-auto mt-7">
                            <div class="text-center">
                                <img src="images/Setting/<?=$setting['logo_kantor'];?>" width="80px">
                            </div>
                        </div>
                                            ...
                                            <div class="tab-pane active" id="reset">
                                                <form method="POST">
                                                    <div class="wrap-input100 validate-input input-group">
                                                        ...
                                                        <input class="input100 border-start-0 form-control ms-0" type="text" placeholder="Masukkan Nomor HP" name="kontak">
                                                    </div>
                                                    <div class="container-login100-form-btn">
                                                        <button class="login100-form-btn btn-primary" name="reset">
                                                            Reset
                                                        </button>
                                                    </div>
                                                </form>
