...
<?php
$title 	= " Laporan Hasil Pemilihan Calon Kepala Desa";
...
WHERE id_kecamatan='$id_kecamatan' AND tanggal_hasil BETWEEN '$dari' AND '$sampai'
");
...
<td align='center'>".tgl($data['tanggal_hasil'])."</td>

<td align='center'>".$data['hasil_polling']."</td>
