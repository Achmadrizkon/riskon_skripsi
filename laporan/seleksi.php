...
<?php
$title 	= " Laporan Seleksi Calon Kepala Desa";
...
WHERE id_kecamatan='$id_kecamatan' AND tanggal_seleksi BETWEEN '$dari' AND '$sampai'
");
...
<td align='center'>".tgl($data['tanggal_seleksi'])."</td>
