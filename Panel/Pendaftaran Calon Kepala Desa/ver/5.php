...
$sql = mysqli_query($koneksi,"SELECT * FROM hasil 
...
$id = $data['id_hasil'];
$ss = mysqli_query($koneksi,"SELECT * FROM kepaladesa WHERE id_hasil='$id'");
...
<?php if ($level_user == "Administrator"): ?>
    <?php 
        ...
        ?>
            <td align="center">
            <a href="index.php?page=Kepala Desa Terpilih&form=Tambah&id=<?=$id;?>" class="btn btn-icon btn-success">
            Pilih Sebagai Kepala Desa
            </a>
            </td>
        <?php
        }
...
<?php 
    ...
    ?>
    <td align="center">
    <a href="index.php?page=Hasil Pemilihan Calon Kepala Desa&form=Hapus&id=<?=$id;?>" class="btn btn-icon btn-danger" onclick="return confirm('Yakin ingin menghapus data?')">
