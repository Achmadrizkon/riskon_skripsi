      ...
      <div class="row">
        ...
        <div class="col-xl-10 col-sm-10 col-md-12">
          <a href="javascript:void(0)">
            <h4 class="mb-1 text-dark"><?=$data['desa'];?> | <?=$data['nama_kecamatan'];?></h4>
          </a>
          <p>Pendaftaran dibuka dari tanggal <?=tgl($data['tanggal_mulai']);?> sampai tanggal <?=tgl($data['tanggal_selesai']);?></p>
          <a href="index.php?page=Pendaftaran Calon Kepala Desa&form=detail&id=<?=$id;?>">Cek Calon Pendaftar <i class="ion-chevron-right fs-10 ms-1"></i>
          </a>
        </div>
      </div>
    </div>
